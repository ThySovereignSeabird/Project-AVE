...
Let "adjacency" be a value where entry [i][j] of the "adjacency matrix" expresses the confidence that color i is succeeded by color j in the sprite's color ramp.
...
### Perceptual contrast
Perceptual contrast in pixel art should be computed from a weighted distance formula of L, a, b in the Oklab color space:
